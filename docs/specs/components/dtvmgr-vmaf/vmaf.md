...
```text
[0:v]scale=1920:1080:flags=bicubic[distorted]; # testdata-ok: ffmpeg resolution spec, not IPv6
[1:v]scale=1920:1080:flags=bicubic[reference]; # testdata-ok: ffmpeg resolution spec, not IPv6
